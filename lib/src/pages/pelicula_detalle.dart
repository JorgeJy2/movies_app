    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        background: FadeInImage(
          image: NetworkImage(pelicula.getBackgroungImgUrl()),
      ...
      child: Column(
        children: <Widget>[
          ClipRRect(
            borderRadius: BorderRadius.circular(20.0),
            child: FadeInImage(
              image: NetworkImage(actor.getPhotoImgUrl()),
          ...
          ListTile(
            title: Text(actor.character, overflow: TextOverflow.ellipsis),
            subtitle: Text(actor.name, overflow: TextOverflow.ellipsis),
          )
        ],
      ),
    );
